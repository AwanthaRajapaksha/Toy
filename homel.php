			...
			<td width="50%">
				<div style="width: 100%; height: 480px; background-color: #68dc00; border-radius: 50px; padding-top: 20px;">
					...
					<center><button style="width: 200px; height: 35px; border-radius: 50px; background-color: white;">
						<?php echo "<a href =add_page.php?id=0>Select ></a>"; ?>
						</button></center>
				</div>
			</td>
						...
						<td width="50%">
							...
							<table>
								<tr>
									...
									<center><button style="width: 200px; height: 35px; border-radius: 50px; background-color: white;">
										<?php echo "<a href =add_page.php?id=1 >Select> </a>";  ?></button></center>
									</div>
									</td>
						...
						<td width="50%">
							...
							<table>
								<tr>
									...
									<center><button style="width: 200px; height: 35px; border-radius: 50px; background-color: white;"><?php echo "<a href =add_page.php?id=2>Select ></a>"; ?></button></center>
									</div>
									</td>
		...
		<table>
			<tr>
				...
				<div style="margin-right:20px;">
					...
					<center><button style="width: 200px; height: 35px; border-radius: 50px; background-color: white;"><?php echo "<a href =add_page.php?id=3>Select ></a>"; ?></button></center>
					</div>
				</div>
				...
				<div style="margin-right:20px;">
					...
					<center><button style="width: 200px; height: 35px; border-radius: 50px; background-color: white;"><?php echo "<a href =add_page.php?id=4>Select ></a>"; ?></button></center>
					</div>
				</div>
				</td>
				...
				<div style="margin-right:20px;">	
					...
					<center><button style="width: 200px; height: 35px; border-radius: 50px; background-color: white;"><?php echo "<a href =add_page.php?id=5>Select ></a>"; ?></button></center>
					</div>
				</div>
		...
		<center>
				<div style="border: 5px solid grey; border-radius: 30px; height: 100%; padding-top: 40px; margin: 5px;"><center>
					...
					<div style="color: white;">
						<button class="fa fa-trash" style="background-color: grey; width: 100px;" onclick="window.location.href='profile.php?id=<?php echo $row["id"] ?>'">More ></button>
					</div>
					</center>
				</div>
